...
public class ComputeSet {
	...
	private int prime = 1;  //素数
	private Map<String, Integer> primes = new HashMap<>();   //映射
	private HashMap<String, ATNode> labels = new HashMap<>();    //映射
	private Set<BigInteger> closeSet = new HashSet<BigInteger>();  //集合
	...
	private boolean isprime(int i) {        //判断是否为素数
